 ...
 */
@Stateless
public class RespuestaDaoImp extends AbstractFacade<Respuesta> implements RespuestaDao{
    ...
    public List<Respuesta> listaRespuestaPorPregunta(Object id) {
        Query q=em.createQuery("SELECT r FROM Respuesta r JOIN R.idPregunta as resp WHERE resp.idPregunta= :idPregunta");
